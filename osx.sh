...
sudo scutil --set ComputerName "NB1004"
sudo scutil --set HostName "NB1004"
sudo scutil --set LocalHostName "NB1004"
...
# Dock: position the Dock on the right
...
defaults write org.m0k.transmission IncompleteDownloadFolder -string "${HOME}/Downloads/TORRENTSs/TEMP"
...
# Trackpad: enable three finger drag (logout required)
